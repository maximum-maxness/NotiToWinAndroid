...
public class ServerOLD {
     ...
     */
    public ServerOLD(String ip, int port, int connectionMethod, String serverName, String osName, String osVersion) {
        this.ip = ip;
        this.port = port;
    ...
    @NonNull
    public static ServerOLD jsonConverter(JSONObject json) throws JSONException {
        ...
        return new ServerOLD(ip, port, connectionMethod, serverName, osName, osVersion);
    }
